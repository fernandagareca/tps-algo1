...
void adivinar_contrasenia(char contrasenia_adivinada[MAX_CONTRASENIA]){
    ...
    calcular_resultados( digitos, tope_digitos,respuesta_codigo,respuesta_mascota,respuesta_numeros_primos,respuesta_numero,respuesta_felino);
        ...
        contrasenia_adivinada[0] = respuesta_codigo;
        contrasenia_adivinada[1] = respuesta_mascota;
        contrasenia_adivinada[2] = respuesta_numeros_primos;
        contrasenia_adivinada[3] = respuesta_numero;
        contrasenia_adivinada[4] = respuesta_numeros_primos;
        contrasenia_adivinada[5] = respuesta_felino;          
}